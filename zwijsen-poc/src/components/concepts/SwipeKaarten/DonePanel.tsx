    ...
    >
      ...
      <div className="w-full rounded-2xl bg-surface-muted px-4 py-4 text-left">
        <dl className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div>
            <dt className="text-xs font-bold uppercase tracking-wide text-text-secondary">Pogingen</dt>
            <dd className="text-2xl font-black text-text-primary">{attempts}</dd>
          </div>
      ...
      <button
        type="button"
        onClick={onRestart}
        className="flex min-h-[52px] w-full items-center justify-center gap-2 rounded-2xl bg-brand-orange px-4 py-3 text-sm font-black uppercase tracking-wide text-text-inverted shadow-md transition-opacity hover:bg-brand-orange-hover"
      >
