...
import InvullenZinExercise from "./InvullenZinExercise";
import DonePanel from "./DonePanel";
import { vloggenInvullenZinContent } from "./examples";
...
export interface InvullenZinProps {
  content?: InvullenZinContent;
}

export default function InvullenZin({ content }: InvullenZinProps) {
  const resolved = content ?? vloggenInvullenZinContent;
  const brief = {
